@description('The resourceId for the scope of the assignment.  Defaults to the resource group.')
param scope string = resourceGroup().id

@description('The objectId for the principal to be granted permission.')
param principalId string

@description('The type of principal of the specified principalId.  Must be one of the of the following if supplied: \'User\', \'Group\', \'ServicePrincipal\', \'ForeignGroup\', \'Device\'. The default is \'ServicePrincipal\'. ')
param principalType string = 'ServicePrincipal'

@description('If a built-in role is used, then the value supplied can be the roleName property for the roleDefinition.  Otherwise, the value must be the resource name of the roleDefinition.')
param roleDefinitionName string

// must be idempotent using the principal, role and scope of the assignment
var roleAssignmentName = guid(principalId, roleDefinitionId, scope)
// if the name is in the list of builtin roles, us it to find the guid/roleDefName, otherwise assume the resource name was provided and not the role description
var roleDefinitionId = (contains(roleNameLookup, roleDefinitionName)) ? subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleNameLookup[roleDefinitionName]) : subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleDefinitionName)
var roleNameLookup = {
  ...
  'CodeSigning Certificate Profile Signer': '2837e146-70d7-4cfd-ad55-7efa6464f958'
  ...
  ContributorNotKeyVault: 'f45dd465-861c-5042-98d7-433e951a1ee6'
  ...
  'deployment-script-minimum-privilege-for-managed-identity': 'c3151571-1dce-552b-b08a-87b752d7ecb7'
  ...
  'Join Subnets': '16eebf7b-257a-43af-821f-d067501e5595'
  ...
  'KeyVault Access Policy Admin': '75e24ef8-beca-58ff-8a18-e0834891088e'
  'KeyVault Deployment Action': '613a9c29-00c4-4c36-93f1-c4d0e0b839a4'
  ...
  'managed-identity-use-deployment-script': 'f9762773-943a-5e9b-9194-3f99b20c5461'
  'managed-identity-use-deployment-script7vfnetoximvwa': 'ef82fabe-4c13-538f-99a8-3a1c5a6af855'
  'managed-identity-use-deployment-scriptbac4jsjeufiky': '79310c7a-4a02-51e4-abb1-bbf00e41c908'
  'managed-identity-use-deployment-scriptikhcyutgtfx7i': '42fb652b-7020-58a9-a934-e48c2ac83cd7'
  'managed-identity-use-deployment-scriptuqowzxb6ttevk': '0493964b-8cd1-514b-ab31-aeab3931ded6'
  'Management Group Contributor': '5d58bcaf-24a5-4b20-bdb6-eed9f69fbe4c'
  'Management Group Deployments': '73ebe240-03af-5565-8b83-909bd9227860'
  'Management Group Reader': 'ac63b705-f282-497d-ac71-919bf39d939d'
  'Marketplace Purchase Deny': '1324632b-0e4f-5847-81cb-e14646f79129'
  ...
  'Scratch Role': '6f3247f1-4890-5942-a0c3-cd3e08d4fedf'
  ...
  'Template Validation and What-If': 'e15b847b-9c9d-5f88-a3db-c916a1f22da7'
  ...
  'Web PubSub Service Owner (Preview)': '12cf5a90-567b-43ae-8102-96cf46c7d9b4'
  'Web PubSub Service Reader (Preview)': 'bfb1c7d2-fb1a-466b-b2ba-aee63b92deaf'
